<?php
    ...
    $sql = "SELECT * FROM eggproduction WHERE archive='archived' ORDER BY eggBatch_ID ASC";
    $stmt = $conn->query($sql);
    if($stmt){
        if($stmt->rowCount() > 0){
            echo '
                ...
                while($row = $stmt->fetch()){
                   ...
                   // $days = $diff->format('%r%a');
                    ...
                    echo "<tr>";
                        ...
                        echo "<td>";
                        //update icon/button
                        echo '<a href="restore_egg.php?id='. $row['eggBatch_ID'] .'" class="m-1 text-decoration-none" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-custom-class="tooltip-expired" data-bs-title="Restore">
                        ...
                        echo '<a href="delete_egg.php?id='. $row['eggBatch_ID'] .'" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-custom-class="tooltip-expired" data-bs-title="Delete">
