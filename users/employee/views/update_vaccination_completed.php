<?php
    ...
    include('../action/update_vaccination_completed.php'); 
    ...
    <div class="row justify-content-center mt-2">
        <div class="col-xl-6 col-md-6">
            <div class="card bg-light shadow-lg mb-4">
                <div class="card-header text-center fw-bold p-3" style="background-color: #FFAF1A;">UPDATE VACCINATION SCHEDULE</div>
                <div class="card-body">
                    ...
                    <div class="card-footer w-100 border d-flex justify-content-end">
                        <div class="m-1 w-100">
                            <a class="fw-bold btn btn-outline-secondary w-100" href="./vaccination_completed.php"> Cancel </a> 
                        </div>
                        <div class="m-1 w-100">
