<?php
    ...
    try{
        ...
        if(isset($_POST['archiveRecord'])){
            ...
            $sql = "BEGIN;
            Archive FROM chickenreduction WHERE chickenBatch_ID = '$id';
            Archive FROM schedules WHERE chickenBatch_ID = '$id';
            Archive FROM chickenproduction WHERE chickenBatch_ID = '$id';
            COMMIT;
            ";
    ...
    <div class="row justify-content-center mt-2">
        <div class="col-sm-4">
            <div class="card bg-light shadow-lg mb-4 ">
                ...
                <div class="text-center" style="background-color: #FFAF1A; color: #91452c">Are you sure you want to Archive this record?</div> <div>
