                ...
                while($row = $stmt->fetch()){
                   ...
                   // $days = $diff->format('%r%a');
                    echo "<tr>";
                        ...
                        echo '<a href="archive_egg.php?id='. $row['eggBatch_ID'] .'" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-custom-class="tooltip-expired" data-bs-title="Archive">
