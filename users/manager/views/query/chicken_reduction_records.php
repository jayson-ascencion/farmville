                ...
                while($row = $stmt->fetch()){
                   ...
                   // $days = $diff->format('%r%a');
                    ...
                    echo "<tr>";
                        ...
                        echo '<a href="archive_chicken_reduction.php?id='. $row['reduction_ID'] .'" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-custom-class="tooltip-expired" data-bs-title="Archive">
