<?php
    ...
    //include the script to update schedule
    include('../action/update_medication_completed.php'); 
?>
    ...
    <div class="row justify-content-center mt-2">
        <div class="col-xl-6 col-md-6">
            <div class="card bg-light shadow-lg mb-4">
                <div class="card-header text-center fw-bold p-3" style="background-color: #FFAF1A;"> UPDATE MEDICATION SCHEDULE </div>
                <div class="card-body">
