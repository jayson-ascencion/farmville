                ...
                <div class="card-header text-center fw-bold p-3"  style="background-color: #FFAF1A; color: #91452c">
                    <div>Are you sure you want to Archive this record?</div>
                        ...
                        <!-- <div class="card-footer w-100 border d-flex justify-content-between">
                            <div class="w-100 m-1">
                                <a class="btn btn-outline-secondary fw-bold w-100" href="./medication_pending.php">
                                    Cancel
                                </a> 
                            </div>
                            <div class="w-100 m-1">
                        ...
                        <div class="card-footer w-100 border d-flex justify-content-between">
                            <div class="w-100 m-1">
                                <a class="small btn btn-outline-secondary fw-bold w-100" href="./medication_pending.php">
                                    Cancel
                                </a> 
                            </div>
                            <div class="w-100 m-1">
