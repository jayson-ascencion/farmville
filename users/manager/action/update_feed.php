...
try{
    ...
    //define variables
    $feedName = $brand = $startingQuantity = $datePurchased = $success = "";
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "UPDATE feeds SET feedName=:feedName, brand=:brand, startingQuantity=:startingQuantity, datePurchased=:datePurchased WHERE feed_ID = '$id'";
