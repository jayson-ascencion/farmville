...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active">Egg Reduction</li>
    </ol>
                    ...
                    <div class="card  shadow-lg">
                        <div class="card-header" style="background-color: #FFAF1A; color: #91452c">
                            ...
                            <!-- <div class="w-100 d-flex justify-content-between p-2">
                                <div>
                                    <h4 class="pt-2 fw-bold fs-5">Egg Reduction</h4>
                                </div>

                                <div>
                                    <a href="reduction_egg_form.php" class="btn btn-outline-danger pt-2 fs-6">Add Reduction</a>
                                </div>
                            </div> -->
                            <div class="row justify-content-between">
                                <div class="col-xl-3 col-md-6">
                                    <h4 class="pt-2 fs-5 fw-bold">Egg Reduction</h4>
                                </div>

                                <div class="col-xl-2 col-md-2 align-content-end">
                                    <div class="w-100 d-flex justify-content-end">
                                        <div class="m-1 w-100 float-end">
                                            <a href="reduction_egg_form.php" class="btn btn-success shadow-sm w-100 fw-bold">Add Reduction</a>
                                        </div>
                                        <!-- <div class="m-1 w-100">
                        ...
                        <div class="card-body displayTable">
                            <div class="table-responsive m-1">
                                <?php
                                    ...
                                    include('./query/egg_reduction_records.php');
                                ?>
                            </div>
                        </div>
                    </div>
