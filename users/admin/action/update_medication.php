...
try{
    ...
    if(isset($_POST['updateMedication'])){
        ...
        if(empty($chickenBatch_ID)){
            ...
            //statement to select the coopnumber based on the submitted chicken batch id
        ...
        //validate medicine id and if not empty, fetch the medicine name
        if(empty($medicine_ID)){
            $medicine_ID_err = "Please select a medicine";
        }else if(!empty($medicine_ID)){
            //statement to select the medicine name based on the submitted medicine id
