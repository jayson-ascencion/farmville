...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item">
            <a class="text-decoration-none" href="./medication_pending.php">Pending Schedules</a>
        </li>
            ...
            <div class="card bg-light shadow-lg mb-4">
                ...
                <div class="card-body">
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST">
                            ...
                            <select class="form-select" name="chickenBatch_ID">
                                ...
                                <?php
                                    ...
                                    if($stmt){
                                        if($stmt->rowCount() > 0){
                                            while($row = $stmt->fetch()){
                                                if($row['chickenBatch_ID'] != $chickenBatch_ID){?>
                        ...
                        <div class="form-group w-100 mb-3">
                            ...
                            <select class="form-select" name="methodType">
                                ...
                                <?php if($methodType != "Diluted in Water") { ?>
                                    <option value="Diluted in Water">Diluted in Water</option>
                                <?php } ?>
                                <?php if($methodType != "Handfed") { ?>
                                    <option value="Handfed">Handfed</option>
                                <?php } ?>
                                <?php if($methodType != "Injected") { ?>
                                    <option value="Injected">Injected</option>
                                <?php } ?>
                            </select>
                    ...
                    <div class="card-footer w-100 border d-flex justify-content-end">
                        <div class="m-1 w-100">                            
                            <a class="btn btn-outline-secondary fw-bold w-100" href="./medication_pending.php"> Cancel </a> 
                        </div>
                        <div class="m-1 w-100">
