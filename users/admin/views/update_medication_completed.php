<?php
    //page title
    $title = "Update Completed Medication";
    
    //header
    include('../../includes/header.php');

    //include update script
    include('../action/update_medication.php'); 
                ...
                <div class="card-body">
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST">
                        ...
                        <?php
                            ...
                            //store the medication id to the id variable to be used in the update statement
                            $id = $_REQUEST['id'];
                            
                            //statement to select the details of the specific schedule to update for display
                            ...
                            //statement to retrieve the username baase on the administered by on the schedule
                        ...
                        <div class="form-group w-100 mb-3">
                            <label for="methodType" class="mb-2 text-dark">Medication Type</label>
                    ...
                    <div class="card-footer w-100 border d-flex justify-content-end">
                        <div class="m-1 w-100">
                            <a class="btn btn-outline-danger fw-bold w-100" href="./medication_completed.php"> Cancel </a> 
                        </div>
                        <div class="m-1 w-100">
                            <button type="submit" name="updateMedication" class="btn btn-outline-success fw-bold w-100">
                                Save
                            </button>    
                        </div>
                    </div>
