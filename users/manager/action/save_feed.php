...
try{
    ...
    if(isset($_POST['submit'])){
        ...
        //     $datePurchased_err = "Please enter a date && empty($startingQuantity_err).";  && empty($datePurchased_err)
        // }

        if(empty($feedName_err) && empty($brand_err) && empty($inStock_err)){

           // Prepare an insert statement
           $sql = "INSERT INTO feeds (feedName, brand, inStock) VALUES (:feedName, :brand, :inStock)";
