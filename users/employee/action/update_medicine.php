...
try{
    ...
    //define variables
    $medicineType = $medicineName = $medicineBrand = $medicineFor = $inStock =  $expirationDate = $success = $futureDate = "";
    ...
    if(isset($_POST['submit'])){
        ...
        if(empty($medicineType_err) && empty($medicineName_err) && empty($medicineBrand_err) && empty($medicineFor_err) && empty($expirationDate_err)){

           // Prepare an insert statement
           $sql = "UPDATE medicines SET medicineType=:medicineType, medicineName=:medicineName, medicineBrand=:medicineBrand, medicineFor=:medicineFor, expirationDate=:expirationDate WHERE medicine_ID = '$id'";
           ...
           if($stmt = $conn->prepare($sql))
           {
            ...
            //    $stmt->bindParam(":inStock", $param_startingQuantity, PDO::PARAM_STR);
            ...
            //    $param_startingQuantity = $inStock;
            ...
            //    $param_dateAdded = $dateAdded;
               ...
               if($stmt->execute())
               {
                    ...
                    $sql = "UPDATE medicinetransaction SET medicineName=:medicineName WHERE medicine_ID = '$id'";
