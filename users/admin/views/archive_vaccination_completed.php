    ...
    try{
        ...
        if(isset($_POST['archiveRecord'])){
            ...
            if($stmt = $conn->prepare($sql))
            {
                ...
                if($stmt->execute())
                {
                    $success = "Medicine is successfully saved.";
    ...
    <div class="row justify-content-center mt-2">
        <div class="col-sm-4">
            <div class="card bg-light shadow-lg mb-4 ">
                ...
                <div>ARCHIVE VACCINATION SCHEDULE</div>
            </div>
                        ...
                        <div class="card-footer w-100 border d-flex justify-content-between">
                            <div class="w-100 m-1">
                                <a class="small btn btn-outline-danger fw-bold w-100" href="./vaccination_completed.php">
                                    Cancel
                                </a> 
                            </div>
                            <div class="w-100 m-1">
