<?php
    ...
    $sql = "SELECT * FROM eggtransaction WHERE archive = 'not archived' AND transactionType = 'Collection' ORDER BY collection_ID ASC";
    $stmt = $conn->query($sql);
    if($stmt){
        if($stmt->rowCount() > 0){
            echo '
                ...
                while($row = $stmt->fetch()){
                   ...
                   // $days = $diff->format('%r%a');
                    echo "<tr>";
                        ...
                        echo "<td>";
                        //update icon/button
                        echo '<a href="update_egg_form.php?id='. $row['collection_ID'] .'" class="m-1 text-decoration-none" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-custom-class="tooltip-expired" data-bs-title="Edit Record">
                        ...
                        echo '<a href="viewEggProd.php?id='. $row['collection_ID'] .'" class="m-1 text-decoration-none" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-custom-class="tooltip-expired" data-bs-title="View Record">
                        ...
                        echo '<a href="archive_egg.php?id='. $row['collection_ID'] .'" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-custom-class="tooltip-expired" data-bs-title="Archive">
