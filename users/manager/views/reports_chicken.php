...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active">Chicken Reports </li>
    </ol>
            ...
            <div class="row">
                <div class="p-0">
                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="col-xl-3 col-md-3 align-content-end">
                                    <div class="w-100 d-flex text-center  justify-content-end">
                                        ...
                                        <div>
                                        <form id="download-form" action="../action/download_chicken.php" method="post">
                    ...
                    <div class="card mt-3 shadow-lg">
                        <div class="card-body">
                            <div class="table-responsive m-1">
                                <h5 class="text-center" style="color: rgb(100, 100, 100)">In Stock Summary By Breed</h5>
                                <div class="chart-container pie-chart">
        ...
        function fetch_data(start, end)
        {
            ...
            var dataTable = $('#second_table').DataTable({
                ...
                "ajax" : {
                    url:"../action/reports_action.php",
                    type:"POST",
                    data:{action:'reduction', start_date:start_date, end_date:end_date}
                },
                "drawCallback" : function(settings)
                {
